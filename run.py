...
if __name__ == '__main__':
    ...
    L, nums, edge_dic, train_dic, test_dic, neg_test_dic, n_train, n_test ,user_item_matrix,_= loaddata_link.readdata(args)
    ...
    *********************************************************
    ...
    print('best: best_auc=[%.5f], best_ap=[%.5f]' % (best_auc, best_ap))
    t3 = time()
    np.savetxt('./data/'+args.dataset+args.split+'_acc.txt',lossdic)
